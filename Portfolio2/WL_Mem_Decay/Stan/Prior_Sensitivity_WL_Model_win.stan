data{
  ...
  real prior_mean_beta_win;
  real<lower=0> prior_sd_beta_win;
}
...
model{
  ...
  target += normal_lpdf(beta_loss | 0, 0.5);
  target += normal_lpdf(beta_win | prior_mean_beta_win, prior_sd_beta_win);  
...
generated quantities{
  ...
  beta_loss_prior = normal_rng(0, 0.5);
  beta_win_prior = normal_rng(prior_mean_beta_win, prior_sd_beta_win);
